...
class CheckPcreRegexpMatchTest : public ::testing::TestWithParam<MatcherTestDataElement> {};
...
INSTANTIATE_TEST_CASE_P(M, CheckPcreRegexpMatchTest, testing::ValuesIn(g_matcher_test_data));
